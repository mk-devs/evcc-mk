...
func NewE3dcFromConfig(other map[string]interface{}) (api.Meter, error) {
	...
	return NewE3dc(cfg, cc.Usage, cc.DischargeLimit, cc.UseInternalPower, cc.UseExternalPower, cc.batteryCapacity.Decorator(), cc.pvMaxACPower.Decorator())
}
...
func (m *E3dc) CurrentPower() (float64, error) {
	...
	case templates.UsagePV:
		...
		res, err := m.retryMessages(questions)
		if err != nil {
			return 0, err
		}
